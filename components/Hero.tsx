...
export function Hero() {
    ...
    return (
        <section
            id="top"
            className="relative bg-background overflow-hidden min-h-[100svh] flex flex-col pt-16"
        >
            {/* background image */}
                    ...
                    <div className="lg:col-span-6 flex flex-col items-start">
                        ...
                        >
                            {avatars.map((a, i) => (
                                <div
                                    key={i}
                                    className="relative h-[52px] w-[52px] rounded-full p-[3px] bg-background"
                                    style={{ zIndex: avatars.length - i }}
                                >
                                    <div className="h-full w-full rounded-full p-[2px] bg-brand">
                        ...
                        >
                            <div className="flex marquee whitespace-nowrap">
                                {[...tickerItems, ...tickerItems, ...tickerItems].map((it, i) => (
                                    <span
                                        key={i}
                                        className="inline-flex items-center gap-2 px-4 text-[11px] font-semibold text-[#101729] tracking-[0.12em] uppercase font-display"
                                    >
                                        <span>{it.icon}</span>
                                        <span>{it.t}</span>
                                    </span>
                        ...
                        <motion.h1
                            ...
                            className="font-display text-white text-[2.4rem] md:text-[clamp(2.8rem,6.2vw,5.2rem)] leading-[0.95] tracking-[-0.04em]"
                        >
                            We <span className="text-[#101729]">code,</span> you{" "}
                            <span className="text-[#101729]">grow</span>
                            <br />
                            that&apos;s the deal
                        </motion.h1>
                        ...
                        >
                            ...
                            >
                                <div className="bg-brand text-brand-foreground px-6 py-3.5 text-[15px] font-bold transition-colors group-hover:bg-brand/90">
                                    Get My Website
                                </div>
                                <div className="bg-brand text-brand-foreground px-4 py-3.5 flex items-center border-l border-brand-foreground/15 transition-colors group-hover:bg-brand/90">
